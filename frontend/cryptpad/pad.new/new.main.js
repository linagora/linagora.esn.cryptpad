...
define([
    '/cryptpad/cryptpad/customize.dist.new/messages.js?app=pad',
    '/bower_components/chainpad-crypto/crypto.js',
    '/cryptpad/cryptpad/pad.new/chainpad-netflux.js',
    '/bower_components/hyperjson/hyperjson.js',
    '/cryptpad/cryptpad/common.new/toolbar.js',
    '/cryptpad/cryptpad/common.new/cursor.js',
    '/bower_components/chainpad-json-validator/json-ot.js',
    '/cryptpad/cryptpad/common.new/TypingTests.js',
    'json.sortify',
    '/bower_components/textpatcher/TextPatcher.amd.js',
    '/cryptpad/cryptpad/common.new/cryptpad-common.new.js',
    '/cryptpad/cryptpad/common.new/visible.js',
    '/cryptpad/cryptpad/common.new/notify.js',
    'config',
